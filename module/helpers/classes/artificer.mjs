...
export class Artificer {
  ...
  static classFeatures = [
    ...
    },
    {
      ...
      selections: {
        ...
        "1.magicSkill": {
          ...
          showWhen: (actor) =>
            actor.system.classes.artificer.bonus["1"].bonus == "magicSkill",
      ...
      spellStudies: [
        ...
        },
        {
          ...
          showWhen: (actor) =>
            actor.system.classes.artificer.bonus["1"].bonus == "enchantment",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      selections: {
        ...
        "2.magicSkill": {
          ...
          showWhen: (actor) =>
            actor.system.classes.artificer.bonus["2"].bonus == "magicSkill",
          onChange: (actor, from, to) => actor.setSkillBoost(from, to, false),
        },
      },
      spellStudies: [
        {
          ...
          showWhen: (actor) =>
            actor.system.classes.artificer.bonus["2"].bonus == "enchantment",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      selections: {
        ...
        "3.magicSkill": {
          ...
          showWhen: (actor) =>
            actor.system.classes.artificer.bonus["3"].bonus == "magicSkill",
          onChange: (actor, from, to) => actor.setSkillBoost(from, to, false),
        },
      },
      spellStudies: [
        {
          ...
          showWhen: (actor) =>
            actor.system.classes.artificer.bonus["3"].bonus == "enchantment",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      selections: {
        ...
        "4.magicSkill": {
          ...
          showWhen: (actor) =>
            actor.system.classes.artificer.bonus["4"].bonus == "magicSkill",
          onChange: (actor, from, to) => actor.setSkillBoost(from, to, false),
        },
      },
      spellStudies: [
        {
          ...
          showWhen: (actor) =>
            actor.system.classes.artificer.bonus["4"].bonus == "enchantment",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      onUnlock: (actor) =>
        actor.updateResource("Alchemist's Pouch", {
          max: 3,
        }),
    },
    {
    ...
    },
    {
      ...
      selections: {
        ...
        "5.magicSkill": {
          ...
          showWhen: (actor) =>
            actor.system.classes.artificer.bonus["5"].bonus == "magicSkill",
          onChange: (actor, from, to) => actor.setSkillBoost(from, to, false),
        },
      },
      spellStudies: [
        {
          ...
          showWhen: (actor) =>
            actor.system.classes.artificer.bonus["5"].bonus == "enchantment",
        },
      ],
    },
    {
    ...
    369: {
      ...
      1: {
        features: [
          {
            onUnlock: (actor) =>
              actor.setSpecialtyFeature(null, "Alchemy", "technology", true),
          },
        ],
      },
    },
  ...
  static async bonus(actor, bonusNumber, from, to) {
    const existingSkill =
      actor.system.classes.artificer.bonus?.[bonusNumber]?.magicSkill;
  ...
  static async initializeSpellFocus(actor, reset) {
    ...
    if (
      actor.system.tableValues.focusEnergy &&
      actor.system.focusEnergy.max != actor.system.tableValues.focusEnergy
    ) {
  ...
  static async castAndStoreSpell(
    actor,
    spell,
    ampFactor,
    ...
    const availableEnergy =
      actor.system.focusEnergy.max - Artificer.getTotalStoredEnergy(actor);
    if (spell.system.energyCost * ampFactor > availableEnergy) {
      ui.notifications.error(
        `${spell.name} wasn't stored because your focus doesn't have enough capacity.`
      );
      return;
    }
    if (await actor.cast(spell, ampFactor, false, energyPool)) {
      ...
      ui.notifications.info(
        `${NewEraUtils.formatSpellName(
          spell,
          ampFactor
        )} has been stored in your focus.`
      );
    } else {
      ui.notifications.warn(
        `Your attempt to store the spell was unsuccessful!`
      );
    }
  }
  ...
  static async onFocusSpellDrop(actor, spell) {
    ...
    if (availableEnergy <= 0) {
      ui.notifications.warn(
        "Your focus is full! Use some of your stored spells to free up some space."
      );
      return;
    }
    if (spell.system.energyCost > availableEnergy) {
      ui.notifications.warn(
        `This spell is too powerful! Your focus can only hold ${availableEnergy} more energy.`
      );
      return;
    }
  ...
  static _renderFocusStorageError(html, spell, actor, ampFactor) {
    ...
    if (spell.system.energyCost * ampFactor > availableEnergy) {
      ...
      if (spell.system.energyCost > availableEnergy) {
        html
          .find(".storage-exceeded-msg")
          .html(
            `This spell is too powerful for your focus! It can only hold ${actor.system.focusEnergy.max} energy worth of spells.`
          );
      } else {
        html
          .find(".storage-exceeded-msg")
          .html(
            `This spell is too powerful! Your focus can only hold ${availableEnergy} more energy. Reduce the amplification level to store it.`
          );
      }
    } else {
