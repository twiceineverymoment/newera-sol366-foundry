...
export class Ranger {
  ...
  static classFeatures = [
    {
      ...
      selections: {
        1: {
          label: "Specialty #1",
          options: {
            navigation: "Navigation (Instinct)",
            tracking: "Tracking (Instinct)",
            "animal-handling": "Animal Handling (Instinct)",
            time: "Time (Instinct)",
            weather: "Weather (Instinct)",
            archery: "Archery (Marksmanship)",
            crossbow: "Crossbows (Marksmanship)",
            rifle: "Rifles (Marksmanship)",
            rangedWeaponCrafting: "Crafting (Marksmanship)",
            cooking: "Cooking (Technology)",
            alchemy: "Alchemy (Technology)",
    ...
    },
    {
      ...
      key: false,
      description:
        "You're used to living outdoors and dealing with harsh climates. Choose a Survivalist archetype and gain its benefits.",
      selections: {
        1: {
          ...
          onChange: (actor, oldValue, newValue) =>
            actor.unlockArchetypeFeatures("ranger", newValue, 1),
        },
      },
    },
    {
      ...
      name: "Mountaineer",
      description:
        "The effects of High Winds on you and ranged attacks you attempt are reduced by one level.",
    },
    {
      level: 1,
      archetype: "polar",
    ...
    },
    {
      ...
      description:
        "Your sight isn't affected by rainfall, and you have advantage on saves against diseases.",
    },
    {
      level: 1,
      archetype: "hiker",
    ...
    },
    {
      ...
      name: "Diver",
      description:
        "The difficulty of your Hold Breath action starts at 5 instead of 10.",
    },
    {
      level: 1,
      archetype: "spelunker",
    ...
    },
    {
      ...
      key: false,
      description:
        "If you start a leveled campaign as a Ranger, you have a Class I firearms license. If you start at level 10 or above, your license is Class II.",
    },
    {
      level: 2,
      ...
      actions: [
        {
          ...
          specialties: [],
          description:
            "You mark a creature you can see as your Prey. Use this action during combat only if you don't currently have a living target marked as Prey.",
          difficulty: null,
          actionType: "0",
          rolls: [
            {
      ...
      actions: [
        {
          ...
          specialties: [],
          description:
            "You spend up to five frames Taking Aim at a target before a ranged attack. Each frame adds +1 to your attack roll and increases the attack damage by your Deadeye Damage.",
          difficulty: null,
          actionType: "?",
          rolls: [
            {
      ...
      selections: {
        4: {
          ...
          options: {
            ...
            crossbow: "Crossbows (Marksmanship)",
            rifle: "Rifles (Marksmanship)",
            crafting: "Crafting (Marksmanship)",
            cooking: "Cooking (Technology)",
            alchemy: "Alchemy (Technology)",
            climbing: "Climbing (Athletics)",
            swimming: "Swimming (Athletics)",
      ...
      selections: {
        ...
        "1.increase": {
          ...
          onChange: (actor, from, to) =>
            Ranger.setBonusIncrease(actor, "1", from, to),
          showWhen: (actor) =>
            actor.system.classes.ranger.bonus["1"].bonus == "increase",
        },
        "1.naturalSkill": {
          ...
          showWhen: (actor) =>
            actor.system.classes.ranger.bonus["1"].bonus == "increase" &&
            actor.system.classes.ranger.bonus["1"].increase == "naturalSkill",
        },
        "1.knowledge": {
          label: "Choose a Knowledge",
          dynamicOptions: (actor) => actor.getLearningExperienceOptions(),
          onChange: (actor, from, to) =>
            actor.setLearningExperience(from, to, false),
          showWhen: (actor) =>
            actor.system.classes.ranger.bonus["1"].bonus == "increase" &&
            actor.system.classes.ranger.bonus["1"].increase == "knowledge",
        },
        "1.specialty": {
          label: "Choose a Specialty",
          dynamicOptions: (actor) => actor.getSpecialtyImprovementOptions(),
          onChange: (actor, from, to) =>
            actor.setSpecialtyImprovement(from, to),
          showWhen: (actor) =>
            actor.system.classes.ranger.bonus["1"].bonus == "increase" &&
            actor.system.classes.ranger.bonus["1"].increase == "specialty",
        },
      },
    },
    {
    ...
    },
    {
      ...
      selections: {
        ...
        "2.increase": {
          ...
          onChange: (actor, from, to) =>
            Ranger.setBonusIncrease(actor, "2", from, to),
          showWhen: (actor) =>
            actor.system.classes.ranger.bonus["2"].bonus == "increase",
        },
        "2.naturalSkill": {
          label: "Choose a Skill",
          dynamicOptions: (actor) => actor.getNaturalSkillOptions(),
          ...
          showWhen: (actor) =>
            actor.system.classes.ranger.bonus["2"].bonus == "increase" &&
            actor.system.classes.ranger.bonus["2"].increase == "naturalSkill",
        },
        "2.knowledge": {
          label: "Choose a Knowledge",
          dynamicOptions: (actor) => actor.getLearningExperienceOptions(),
          ...
          showWhen: (actor) =>
            actor.system.classes.ranger.bonus["2"].bonus == "increase" &&
            actor.system.classes.ranger.bonus["2"].increase == "knowledge",
        },
        "2.specialty": {
          label: "Choose a Specialty",
          dynamicOptions: (actor) => actor.getSpecialtyImprovementOptions(),
          ...
          showWhen: (actor) =>
            actor.system.classes.ranger.bonus["2"].bonus == "increase" &&
            actor.system.classes.ranger.bonus["2"].increase == "specialty",
        },
      },
    },
    {
    ...
    },
    {
      ...
      selections: {
        ...
        "3.increase": {
          ...
          onChange: (actor, from, to) =>
            Ranger.setBonusIncrease(actor, "3", from, to),
          showWhen: (actor) =>
            actor.system.classes.ranger.bonus["3"].bonus == "increase",
        },
        "3.naturalSkill": {
          label: "Choose a Skill",
          dynamicOptions: (actor) => actor.getNaturalSkillOptions(),
          ...
          showWhen: (actor) =>
            actor.system.classes.ranger.bonus["3"].bonus == "increase" &&
            actor.system.classes.ranger.bonus["3"].increase == "naturalSkill",
        },
        "3.knowledge": {
          label: "Choose a Knowledge",
          dynamicOptions: (actor) => actor.getLearningExperienceOptions(),
          ...
          showWhen: (actor) =>
            actor.system.classes.ranger.bonus["3"].bonus == "increase" &&
            actor.system.classes.ranger.bonus["3"].increase == "knowledge",
        },
        "3.specialty": {
          label: "Choose a Specialty",
          dynamicOptions: (actor) => actor.getSpecialtyImprovementOptions(),
          ...
          showWhen: (actor) =>
            actor.system.classes.ranger.bonus["3"].bonus == "increase" &&
            actor.system.classes.ranger.bonus["3"].increase == "specialty",
        },
      },
    },
    {
  ...
  static async bonus(actor, bonusNumber, from, to) {
    if (from == "passivePerception") {
      ...
      const currIncrease =
        actor.system.classes.ranger.bonus?.[bonusNumber]?.increase;
      if (currIncrease) {
  ...
  static async setBonusIncrease(actor, bonusNumber, from, to) {
    if (from == "naturalSkill") {
      const naturalSkill =
        actor.system.classes.ranger.bonus?.[bonusNumber]?.naturalSkill;
      if (naturalSkill) {
        await actor.setSkillBoost(naturalSkill, "", true);
      }
    } else if (from == "knowledge") {
      const knowledge =
        actor.system.classes.ranger.bonus?.[bonusNumber]?.knowledge;
      if (knowledge) {
        await actor.setLearningExperience(knowledge, "");
      }
    } else if (from == "specialty") {
      const specialty =
        actor.system.classes.ranger.bonus?.[bonusNumber]?.specialty;
      if (specialty) {
  ...
  static async markPrey(actor, target) {
    if (actor.system.prey) {
      ...
      if (target.id == actor.system.prey) {
        ui.notifications.warn(
          "You have already marked this creature as your Prey."
        );
        return;
      }
      const preyEffect = game.actors
        .get(actor.system.prey)
        .effects.find((e) => e.name == "Prey" && e.origin == actor.name);
    ...
    actor.actionMessage(
      actor.img,
      `${NEWERA.images}/ranger.png`,
      "{NAME} marks {0} as {d} prey!",
      target.name
    );
  }
  ...
  static async removePrey(actor) {
    if (actor.system.prey) {
      const preyEffect = game.actors
        .get(actor.system.prey)
        .effects.find((e) => e.name == "Prey" && e.origin == actor.id);
    }
  }
}
